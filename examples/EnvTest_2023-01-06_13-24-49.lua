...
local ModuleRoot = {
    {
        Children = {
            {
                Closure = function() print("test 1: " .. tostring(getfenv(0)) .. ", " .. tostring(getfenv(1))) end,
                Properties = {
                    Name = "test1"
                },
                Reference = 4,
            ...
            {
                Closure = function() local Ok, FunctionEnvironment = pcall(getfenv, 2)
print("`getfenv(2)` status (should be an error): " .. tostring(FunctionEnvironment)) end,
                Properties = {
                    Name = "no_getfenv_lvl2"
                },
                Reference = 2,
                ClassName = "LocalScript"
            },
            ...
            {
                Closure = function() print("test 2: " .. tostring(getfenv(0)) .. ", " .. tostring(getfenv(1))) end,
                Properties = {
                    Name = "test2"
                },
                Reference = 5,
            ...
            {
                Closure = function() local function f()
